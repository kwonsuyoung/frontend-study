/*
async, awit 사용법. 무조건 함수가 필요!

then과 catch를 사용하지 않고 대체하겠슴니다
*/
...
await는 우측에서 결과가 넘어올 때까지 기다린다.resolve 호출할 때 넘겨줬던 아규먼트 값을 받을 때 사용.
reject 아규먼트 값은 try-catch문법으로 받아야한다
*/
